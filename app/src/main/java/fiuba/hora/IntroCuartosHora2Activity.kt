 ...
 */
class IntroCuartosHora2Activity : IntroActivity() {

    /**
     * Obtiene el intent con la activity que se desea como siguiente.
     */
    override fun getTheIntent(): Intent {
        return Intent(this, IntroCuartosHora3Activity::class.java)
    }
    ...
    override fun getTextId(): Int {
        return R.string.intro_cuartos2_txt
    }
    ...
    override fun getImageId(): Int {
        return R.mipmap.clock_minutes5
    }
}
