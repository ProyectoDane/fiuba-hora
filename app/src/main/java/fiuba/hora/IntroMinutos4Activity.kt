...
class IntroMinutos4Activity : IntroActivity() {
    ...
    override fun getTextId(): Int {
        return R.string.intro_mins4_txt
    }
    ...
    override fun getImageId(): Int {
        return R.mipmap.clock_minutes2
    }
}
