 ...
 */
class IntroMinutos10Activity : IntroActivity() {

    /**
     * Obtiene el intent con la activity que se desea como siguiente.
     */
    override fun getTheIntent(): Intent {
        return Intent(this, IntroMinutos11Activity::class.java)
    }
    ...
    override fun getTextId(): Int {
        return R.string.intro_mins10_txt
    }
    ...
    override fun getImageId(): Int {
        return R.mipmap.clock_minutes13
    }
}
