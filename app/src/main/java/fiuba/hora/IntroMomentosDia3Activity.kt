 ...
 */
class IntroMomentosDia3Activity: IntroActivity() {

    /**
     * Obtiene el intent con la activity que se desea como siguiente.
     */
    override fun getTheIntent(): Intent {
        return Intent(this, IntroMomentosDia4Activity::class.java)
    }
    ...
    override fun getTextId(): Int {
        return R.string.intro_momentos3_txt
    }
